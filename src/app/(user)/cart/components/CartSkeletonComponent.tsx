		...
		<div className="space-y-8 animate-pulse">
			...
			<div className="space-y-6">
				...
				<div className="flex items-center justify-between">
					<div className="flex items-center space-x-3">
						...
						<div className="w-56 h-6 bg-soft-gray/20 rounded" />
					</div>
					<div className="w-32 h-7 bg-sunset-orange/20 rounded-full" />
				</div>
			...
			<div className="space-y-6">
				...
				<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
					<div className="flex items-center space-x-3">
						<div className="w-1 h-6 bg-gradient-to-b from-sunset-orange to-soft-gold rounded-full" />
						<div className="w-52 h-6 bg-soft-gray/20 rounded" />
					</div>
				...
				<div className="space-y-8">
					{['Bebidas', 'Snacks', 'Combos'].map((_, categoryIndex) => (
						<div key={categoryIndex}>
							{/* Category Header */}
							<div className="flex items-center gap-3 mb-4">
								<div className="w-6 h-6 bg-soft-gray/20 rounded" />
								<div className="w-20 h-6 bg-soft-gray/20 rounded" />
								<div className="w-8 h-5 bg-soft-gray/20 rounded-full" />
							</div>
					...
					<div className="bg-deep-night/60 backdrop-blur-xl border border-soft-gray/20 rounded-2xl p-6">
						<div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
							...
							<div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
								<div className="w-32 h-12 bg-soft-gray/20 rounded-xl" />
